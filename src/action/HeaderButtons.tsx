...
function LinkButton({
  ...
  return (
    <a
      className="flex size-10 items-center justify-center rounded-full border border-mirage-300 fill-mirage-950 stroke-mirage-950 outline-none hover:bg-mirage-200 focus-visible:ring-2 focus-visible:ring-primary dark:border-mirage-800 dark:fill-mirage-50 dark:stroke-mirage-50 dark:hover:bg-mirage-800 dark:focus-visible:ring-primary-dark"
      target="_blank"
