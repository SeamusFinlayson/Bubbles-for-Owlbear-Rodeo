    ...
    switch (variant) {
        ...
        case "patreon": return (
            <Tooltip title="Patreon">
                <a className="action-button patreon-button" href="https://www.patreon.com/SeamusFinlayson"
                    target="_blank" rel="noreferrer noopener">
                    <svg className="button-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 436 476" width="19px" height="19px" fill={color} stroke={color}>
                        <path data-fill="1"
        ...
        case "changeLog": return (
            <Tooltip title="Change Log">
                <a className="action-button change-log-button" 
                    href="https://www.patreon.com/collection/306916?view=expanded" target="_blank" rel="noreferrer noopener">
                    <svg className="button-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill={color} stroke={color}>
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M12 8V12L14.5 14.5" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path
        ...
        case "help": return (
            <Tooltip placement="bottom-start" title="Instructions">
                <a className="action-button help-button" 
                    href="https://github.com/SeamusFinlayson/Bubbles-for-Owlbear-Rodeo?tab=readme-ov-file#how-it-works"
                    target="_blank" rel="noreferrer noopener">
                    <svg className="button-svg" width="22px" height="20px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
